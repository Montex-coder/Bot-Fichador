...
VERSIÓN DEFINITIVA - Optimizada para un despliegue profesional 24/7 en Render.
"""
...
def main() -> None:
    ...
    # NOTA: No se usa JobQueue() aquí porque la librería moderna lo gestiona internamente.
